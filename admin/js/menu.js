            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyleds" id="coltaikhoan">
                        <li class="nav-item">
                            <a href="taikhoan.html" class="text-white text-decoration-none ps-4"><i class="fa fa-list"></i> Danh sách tài khoản</a>
                        </li>
                        <li class="nav-item">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyleds" id="colbaiviet">
                        <li class="nav-item">
                            <a href="blog.html" class="text-white text-decoration-none ps-4"><i class="fa fa-list"></i> Danh sách tin đăng</a>
                        </li>
                        <li class="nav-item">
                            <a href="addblog.html" class="text-white text-decoration-none ps-4"><i class="fa fa-plus"></i> Thêm bài viết</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="danhmuc.html" class="text-white text-decoration-none">
                        <i class="fa fa-list"></i> Danh mục
                    </a>
                </li>
                <li>
                    <a href="thuonghieu.html" class="text-white text-decoration-none">
                        <i class="fa-brands fa-apple"></i> Thương hiệu
                    </a>
                </li>
                <li>
                    <a href="banner.html" class="text-white text-decoration-none">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyleds" id="colkhuyenmai">
                        <li class="nav-item">
                            <a href="voucher.html" class="text-white text-decoration-none ps-4"><i class="fa fa-list"></i> Danh sách khuyến mại</a>
                        </li>
                        <li class="nav-item">
                            <a href="addvoucher.html" class="text-white text-decoration-none ps-4"><i class="fa fa-plus"></i> Thêm khuyến mại</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyleds" id="dashboardSubmenu">
                        <li class="nav-item">
                            <a href="product.html" class="text-white text-decoration-none ps-4"><i class="fa fa-list"></i> Danh sách sản phẩm</a>
                        </li>
                        <li class="nav-item">
                            <a href="addproduct.html" class="text-white text-decoration-none ps-4"><i class="fa fa-plus"></i> Thêm sản phẩm</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="invoice.html" class="text-white text-decoration-none">
